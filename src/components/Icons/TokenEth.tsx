...
export function TokenEth(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns={'http://www.w3.org/2000/svg'} width={'1em'} height={'1em'} viewBox={'0 0 24 24'} {...props}>
      ...
      />
      <path fill={'#8D8E8E'} d={'m12 15.81l6.25-3.625L12 9.39zm-6.25-3.625L12 15.81V9.39z'} />
      <path
        fill={'#ADAEAE'}
        fillRule={'evenodd'}
        d={
          'm12 15.81l-6.25-3.625L12 2l6.25 10.185zm-5.835-3.92L11.9 2.545V9.34zm-.085.255L11.9 9.56v5.96zM12.1 9.56v5.96l5.815-3.375zm0-.22l5.735 2.55L12.1 2.545z'
        }
        clipRule={'evenodd'}
      />
      <path
