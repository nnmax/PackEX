  ...
  return (
    <DialogTrigger>
      <Button
        type={'button'}
        className={
          'mt-8 flex h-9 w-full max-w-[240px] items-center justify-center self-center rounded-md bg-lemonYellow text-xs text-[#020202]'
        }
      >
        {'Confirm'}
      </Button>
            ...
            <dl className={'flex flex-col gap-8'}>
              <div>
                ...
                <dd className={'flex items-center justify-between'}>
                  <span className={'text-base'}>{'304.2444962 USDB'}</span>
                  <TokenBlast className={'text-xl'} />
                </dd>
              </div>
              <div>
                <dt className={'mb-4 text-xs text-[#9E9E9E]'}>{'YOU RECEIVE'}</dt>
                <dd className={'flex items-center justify-between'}>
                  <span className={'text-base'}>{'304.2444962 ETH'}</span>
                  <TokenBlast className={'text-xl'} />
                </dd>
              </div>
            </dl>
